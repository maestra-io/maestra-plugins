...
Block names inside the skeletons are shown as captured (real flows are often named in the project's language).
...
```
B_4c2df28 [inboundEventBlock] B_4c2df28:default --> B_e054f9c [delayBlock "Ожидание 30 минут"]
B_e054f9c [delayBlock "Ожидание 30 минут"] B_e054f9c:default --> B_1de3b56 [conditionBlock "Нет заказов, рассылок. Есть подписка на Email"]
B_1de3b56 [conditionBlock "…"] B_1de3b56:positive --> B_00b9338 [operationStepsBlockSettings "Email - брошенная корзина"]
```
...
```
B_2f45b64 [scheduleBlock] --> B_329bd04 [conditionBlock] :positive --> B_896e2e9 [conditionBlock] :positive --> B_543cfd8 [conditionBlock] :positive --> B_9095162 [operationStepsBlockSettings "Шаги 6"]
```
...
B_b81d911 :1(50%) --> B_2c5b5fd [operationStepsBlockSettings "Шаги 2"]   (SMS)
B_b81d911 :2(50%) --> B_ab3b00f [conditionBlock] :positive --> B_0d8f573 [operationStepsBlockSettings "Копия Шаги 2"]   (Email)
```
